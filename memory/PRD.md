...
# IONOS SMTP Configuration (AKTIV)
SMTP_HOST=smtp.ionos.de
SMTP_PORT=587
SMTP_USER=info@oceancolor.de
SMTP_PASSWORD=Sevensevsin661992
SMTP_FROM=info@oceancolor.de
SMTP_USE_TLS=true
```
...
- ✅ Login als info@oceancolor.de
- ✅ Empfänger: info@ocean-maler.de
